#ifndef NS3_CPBASICSERVICEV1_H
#define NS3_CPBASICSERVICEV1_H
...
public:
  ...
  void addCPRxCallback(std::function<void(asn1cpp::Seq<CPMV1>, Address)> rx_callback) {m_CPReceiveCallback=rx_callback;}
  void addCPRxCallbackExtended(std::function<void(asn1cpp::Seq<CPMV1>, Address, StationID_t, StationType_t, SignalInfo)> rx_callback) {m_CPReceiveCallbackExtended=rx_callback;}
